...
public class SagaOrchestratorConsumer {
    ...
    public void consumeStartSagaEvent(String payload) {
        log.info("Recebendo evento {} de start-saga topic", payload);
    ...
    public void consumeOrchestratorEvent(String payload) {
        log.info("Recebendo evento {} de orchestrator topic", payload);
        var event = jsonUtil.toEvent(payload);
    ...
    public void consumeFinishSagaSuccessEvent(String payload) {
        log.info("Recebendo evento {} de finish-success topic", payload);
        var event = jsonUtil.toEvent(payload);
    ...
    public void consumeFinishSagaFailEvent(String payload) {
        log.info("Recebendo evento {} de finish-fail topic", payload);
        var event = jsonUtil.toEvent(payload);
